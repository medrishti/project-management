  ...
  return (
    ...
    <div className='flex items-center gap-8'>
      ...
      <div className='relative flex h-min w-[200px]'>
        ...
        <input type="serach" placeholder='Search...' className='w-full rounded border-none bg-gray-100 p-2 pl-8 placeholder-gray-500 focus:border-transparent focus:outline-none dark:bg-slate-700 dark:text-white dark:placeholder-white' />
      </div>
    ...
    <div className='flex items-center'>
      <button onClick={()=>{dispatch(setIsDarkmode(!isDarkMode))}}
        ...
        >
          {isDarkMode ? (
            <Sun className='h-6 w-6 cursor-pointer dark:text-white'/>) : (<Moon className='h-6 w-6 cursor-pointer dark:text-white'/>
          )}
